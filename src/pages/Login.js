    ...
    return(
        <div className="w-full h-full bg-bg flex flex-row items-center justify-center">
            <div className='w-1/4 h-1/2 flex flex-col justify-start items-center bg-bg shadow-xl rounded-lg'>
                ...
                <input type='text' placeholder='Username' onChange={e => updateUsername(e.target.value)} className='mt-8 p-1 w-3/4 bg-sub-bg rounded text-lg'></input>
                ...
                <button onClick={onLoginHandler} className='p-2 mt-5 text-lg rounded bg-button shadow-lg hover:shadow-xl active:shadow-md transition-all delay-75'>Login</button>
